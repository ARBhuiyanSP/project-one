...
<div class="card mb-3">
    <div class="card-header">
		...
		<button class="btn btn-success linktext"> Collection Report Search</button>
		<button class="btn btn-info linktext" onclick="window.location.href='memberwise_collection_report.php';"> Memberwise Collection Report </button>
	</div>
		...
		<div class="col-md-10" id="printableArea">
			<div class="row">
				<div class="col-sm-12">	
					<center>
						<p>
							...
							<span>Member's Collection Report</span><br>
				...
				<table id="" class="table table-bordered table-striped ">
					...
					<tbody>
					<?php
						$sql	=	"SELECT * FROM `balance_sheet` WHERE `type`='collection' AND `date` BETWEEN '$from_date' AND '$to_date'";
						...
						<?php } ?>
							<tr>
								...
								<td style="text-align:right;">
									<?php	
									$sqlinval = "SELECT SUM(`deposit_amount`) AS totalinval FROM `balance_sheet` WHERE `type`='collection' AND `date` BETWEEN '$from_date' AND '$to_date'";
