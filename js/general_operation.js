...
function get_user_list_data_table(division_id='', department_id=''){
    var url       =   baseUrl + "includes/user_management.php?process_type=getDataTableUserList";
...
function loginAsAnotherUser(login_as_user_id, current_user_id, is_login_as = 1){
    ...
    function () {
        var url       =   baseUrl + "includes/login_process.php?process_type=loginAsAnotherUser";
        $.ajax({
              url         :url,
              type        :"POST",
              dataType    :"json",
...
function getRoleAccessDetails(role_id) {
    $.ajax({
        url: baseUrl + "includes/role_access_management.php?process_type=getRoleAccessByGroupId",
        type: 'POST',
        dataType: 'html',
...
function getDepartmentByBranch(branch_id, department_id='department_id') {
    if(branch_id){
        $.ajax({
            url: baseUrl + "includes/rlp_process.php?process_type=getDepartmentByBranch",
            type: 'POST',
            dataType: 'html',
...
function getDepartmentWiseUsers(branch='branch_id',department='department_id',form_type='chain_create_form',select_id='user_list_section'){
    ...
    $.ajax({
        url: baseUrl + "includes/user_management.php?process_type=getDepartmentusers",
        type: 'POST',
        dataType: 'html',
...
function assignThisUserToChain(user_id){
    ...
    $.ajax({
        url: baseUrl + "includes/user_management.php?process_type=assignThisUserToChain",
        type: 'POST',
        dataType: 'html',
...
function assignThisUserToDefaultChain(user_id){
    var user_name     =   $("#assign_user_name_"+user_id).html();
    $.ajax({
        url: baseUrl + "includes/user_management.php?process_type=assignThisUserToDefaultChain",
        type: 'POST',
        dataType: 'html',
        data: 'user_id=' + user_id+"&user_name="+user_name,
        success: function (response) {
