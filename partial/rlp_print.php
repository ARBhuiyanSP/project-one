...
<section class="invoice" id="printableArea">
    ...
    <!-- /.row -->
	<div class="row">
		<div class="col-sm-3 col-xs-3"><img src="images/signatures/<?php echo getSignatureByUserId($rlp_info->rlp_user_id); ?>" height="70px"/></br><span style="border-top: double;">Requester's Signature </span></div>
